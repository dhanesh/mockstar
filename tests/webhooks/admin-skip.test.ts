...
function makeDeps() {
  ...
  return {
    metrics: {
      ...
      observeLatencyUs: () => undefined,
      setGauge: () => undefined,
    } as unknown as Parameters<typeof dispatchWebhooks>[0]["metrics"],
    ...
    circuitFor: () =>
      ({
        ...
        record: () => undefined,
        metricValue: () => 0 as const,
      }) as unknown as ReturnType<Parameters<typeof dispatchWebhooks>[0]["circuitFor"]>,
